...
function statusChange(order_status_no, orderflee_no){
   ...
   xmlhttp.onreadystatechange = function(){
      if(xmlhttp.readyState== 4 && xmlhttp.status == 200){
         refreshForm();
         tableBox.innerHTML="";
         setTimeout(updateSuccess, 60000, order_no);
      }
   };   
...
//배송중->배송완료
function updateSuccess(orderflee_no){
   var orderNo=orderflee_no;
...
function refreshForm(){
   ...
   xmlhttp.onreadystatechange = function(){
      if(xmlhttp.readyState== 4 && xmlhttp.status == 200){
         ...
         if(orderList.orderFleeMarketVO.order_status_no==2 || orderList.orderFleeMarketVO.order_status_no ==3){
         ...
         setTable.appendChild(tr2);
                ...
                var std7 = document.createElement("td");
                  ...
                  std7Select.setAttribute("onchange", "statusChange(value, "+orderList.orderFleeMarketVO.orderflee_no+")");                  
                  ...
                  if(std7Option.value==orderList.orderFleeMarketVO.order_status_no){
