...
<a href="./loginSellerPage.do"" style="font-size: 30px; font-weight: bold; color: #fcc92f; text-decoration: none; text-align: right;">로그인하기</a>
<a href="./findSellerPwPage.do"" style="font-size: 30px; font-weight: bold; color: #fcc92f; text-decoration: none; text-align: right;">비밀번호 찾기기</a>
