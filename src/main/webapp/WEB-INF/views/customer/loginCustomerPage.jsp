...
<body>
	<div id="wrap">
		...
		<div class="login_area">
			<form id="xxx2" action="${pageContext.request.contextPath }/customer/loginCustomerProcess.do" method="post">
				
				<div class="input_area">
					<span class="formStyle">아이디</span> 
					<input id="loginId" class="idBox" type="text" name="customer_id">
					
					<span class="formStyle">비밀번호</span>
					<input id="loginPw" class="pwBox"  type="password" name="customer_pw">
				</div>
				
				<div>
					<button class="btn_login" type="button" onclick="formSubmit()" style="margin-bottom: 5px;">로그인</button>
					<button class="btn_login" type="button" onclick="location.href='./joinCustomerPage.do'">회원가입</button>
				</div>
			</form>
		</div>
