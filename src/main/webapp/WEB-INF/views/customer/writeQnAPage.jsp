...
<div class="container">
	...
	<div class="row">
		...
		<div class="row" style="color: #5b5b5b; max-height: 40px; height:40px; font-size: 25px; font-weight: bold; text-align: center; ">
				...
				<form
					action="${pageContext.request.contextPath }/customer/qnaWriteContentProcess.do"
					...
					<div class="row">
						...
						<div class="col" style="max-height: 50px; height: 50px; border: 1px solid gray; border-bottom: 0px solid white;">
							<input type="text" id="QnAtitle" name="customerQnA_title" value="제목을 입력해주세요" style="max-height: 48px; height: 48px; width: 980px; max-width:980px;">
						</div>
					</div>
					<div class="row"
						style="max-height: 400px; height: 400px; border: 1px solid gray; border-bottom: 0px solid white;">
						<input type="text" id="QnAcontent" name="customerQnA_content"	value="내용을 입력해주세요">
					</div>
					<div class="row"
